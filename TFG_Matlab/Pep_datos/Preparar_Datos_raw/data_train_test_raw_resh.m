...
T_X = total_cells(total_etiquetas=='T');
T_Y = total_etiquetas(total_etiquetas=='T');

Q_X = total_cells(total_etiquetas=='Q');
Q_Y = total_etiquetas(total_etiquetas=='Q');

V_X = total_cells(total_etiquetas=='V');
V_Y = total_etiquetas(total_etiquetas=='V');

M_X = total_cells(total_etiquetas=='M');
...
save('valores_reshape_raw', 'XTrain', 'YTrain','XTest','YTest');
